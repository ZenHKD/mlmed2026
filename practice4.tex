...
The pipeline achieves a mean FROC score of $\mathbf{0.731 \pm 0.036}$ across the five validation folds. At low FP rates ($\leq$0.5 FP/scan), sensitivity ranges from 28.6\% to 63.4\%, indicating room for improvement in reducing false positives. At higher FP rates ($\geq$2 FP/scan), sensitivity exceeds 89.7\%, demonstrating strong nodule detection capability when a moderate number of false positives is tolerable. Note that sensitivities exceeding 1.0 at high FP rates arise because a single ground-truth nodule can be matched by multiple nearby candidates.
...
\begin{table}[H]
\centering
\caption{Comparison of FROC scores on the LUNA16 dataset. Published results are taken from \cite{liu2019_3dfpn}, \cite{yang2018_s4nd}, and \cite{zhu2018_deeplung}.}
\label{tab:froc_comparison}
\begin{tabular}{l|c|c|c}
\hline
\textbf{Method} & \textbf{Params} & \textbf{FROC} & \textbf{Subsets} \\
\hline
3DFPN-HS$^2$~\cite{liu2019_3dfpn} (2019) & - & 0.952 & 10 \\
S4ND~\cite{yang2018_s4nd} (2018)          & $\sim$4.6M & 0.897 & 10 \\
DeepLung~\cite{zhu2018_deeplung} (2018)   & - & 0.834 & 10 \\
\hline
...
\bibitem{liu2019_3dfpn}
Liu, J., Cao, L., Akin, O., and Tian, Y.
\newblock 3DFPN-HS$^2$: 3D Feature Pyramid Network Based High Sensitivity and Specificity Pulmonary Nodule Detection.
\newblock \textit{arXiv preprint arXiv:1906.03467}, 2019.
\newblock \url{https://arxiv.org/abs/1906.03467}

\bibitem{yang2018_s4nd}
Yang, J., Veasey, T., Yuan, K., and Tsaftaris, S.~A.
\newblock S4ND: Single-Shot Single-Scale Lung Nodule Detection.
\newblock In \textit{Medical Image Computing and Computer Assisted Intervention (MICCAI)}, 2018.
\newblock \url{https://arxiv.org/abs/1805.02279}

\bibitem{zhu2018_deeplung}
Zhu, W., Liu, C., Fan, W., and Xie, X.
\newblock DeepLung: 3D Deep Convolutional Nets for Automated Pulmonary Nodule Detection and Classification.
\newblock In \textit{IEEE Winter Conference on Applications of Computer Vision (WACV)}, 2018.
\newblock \url{https://arxiv.org/abs/1709.05538}
